...
| hrsh7th/cmp-nvim-lsp | 99290b3 | LSP 补全源 |
| hrsh7th/cmp-buffer | b74fab3 | 缓冲区补全 |
| hrsh7th/cmp-path | c642487 | 路径补全 |
| hrsh7th/cmp-nvim-lua | f12408b | Lua API 补全 |
| saadparwaiz1/cmp_luasnip | 98d9cb5 | LuaSnip 补全源 |
| L3MON4D3/LuaSnip | v2.4.0 | 代码片段引擎 |
| onsails/lspkind-nvim | 3ddd1b4 | 补全菜单图标 |

### A.2 代码编辑与高亮（5个）

| 插件 | 版本 | 用途 |
|------|------|------|
| jackguo380/vim-lsp-cxx-highlight | e0c749e | C/C++ 语义高亮 |
| fzhzhen1987/vim-gutentags | d411add | 自动 ctags/gtags |
| nvim-treesitter/nvim-treesitter | v0.9.2 | 语法树解析 |
| nvim-treesitter/nvim-treesitter-textobjects | 71385f1 | Treesitter 文本对象 |
...
| azabiong/vim-highlighter | 1.63 | 高亮标记 |
| dominikduda/vim_current_word | 967c738 | 高亮当前词 |
| nathanaelkane/vim-indent-guides | a1e1390 | 缩进指南 |
| mg979/vim-visual-multi | v0.5.8 | 多光标编辑 |
| jiaoshijie/undotree | eab459a | 撤销历史树 |
...
| 插件 | 版本 | 用途 |
|------|------|------|
| airblade/vim-gitgutter | 488c055 | Git 差异显示 |

### A.5 工具与查找（8个）

| 插件 | 版本 | 用途 |
|------|------|------|
| voldikss/vim-floaterm | fd4bdd6 | 浮动终端 |
| ptzz/lf.vim | v1.4 | lf 文件管理器 |
| iberianpig/tig-explorer.vim | ac49ff1 | tig Git TUI |
| Yggdroot/LeaderF | v1.25 | 模糊查找 |
| kevinhwang91/nvim-bqf | v1.1.1 | QuickFix 增强 |
| nvim-telescope/telescope.nvim | 0.1.0 | 模糊查找系统 |
| nvim-telescope/telescope-fzf-native.nvim | 1f08ed6 | FZF 原生搜索 |
...
| 插件 | 版本 | 用途 |
|------|------|------|
| kristijanhusak/vim-hybrid-material | HEAD | hybrid_reverse 主题 |
| akinsho/bufferline.nvim | v3.7.0 | 顶部标签栏 |
| nvim-tree/nvim-web-devicons | HEAD | 文件图标 |
| nvim-lualine/lualine.nvim | compat-nvim-0.5 | 底部状态栏 |
| folke/which-key.nvim | 904308e | 键位提示 |
