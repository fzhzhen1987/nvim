...
-- ========================================
-- vim-floaterm 配置
-- 来源：plug_list.vim line 366-367
-- ========================================
M.setup_floaterm = function()
    -- 浮动窗口大小设置
    vim.g.floaterm_width = 0.9   -- 宽度 90%
    vim.g.floaterm_height = 0.9  -- 高度 90%

    -- 设置 floaterm 打开文件的方式为新 tab（在 lf 中按右方向键打开文件）
    vim.g.floaterm_opener = 'tabe'
end

-- ========================================
-- lf.vim 配置
-- 来源：plug_list.vim line 363-364
-- ========================================
M.setup_lf = function()
    -- 禁用默认键位
    vim.g.lf_map_keys = 0

    -- 键位映射：<leader>ra 打开 lf 文件管理器
    vim.keymap.set('n', '<leader>ra', ':Lf<CR>', {
        silent = true,
        desc = '打开lf文件管理器'
    })
end
...
-- ========================================
-- vim-floaterm 全局配置
-- 来源：vim-floaterm 默认配置
-- ========================================
M.setup_floaterm_global = function()
    -- 设置 floaterm 打开文件的方式为新 tab
    vim.g.floaterm_opener = 'tabe'
end
